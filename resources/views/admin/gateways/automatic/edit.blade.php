                                                ...
                                                <div class="card border--primary">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="number" step="any" class="form-control minAmount" name="currency[{{ $currencyIndex }}][min_amount]" value="{{ getAmount($gatewayCurrency->min_amount, 8) }}" required>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="number" step="any" class="form-control maxAmount" name="currency[{{ $currencyIndex }}][max_amount]" value="{{ getAmount($gatewayCurrency->max_amount, 8) }}" required>
                                                                <div class="input-group-text">{{ __(gs('cur_text')) }}</div>
                                                            </div>
                                                ...
                                                <div class="card border--primary">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="number" step="any" class="form-control" name="currency[{{ $currencyIndex }}][fixed_charge]" value="{{ getAmount($gatewayCurrency->fixed_charge, 8) }}" required>
                                                                <div class="input-group-text">{{ __(gs('cur_text')) }}</div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="number" step="any" class="form-control" name="currency[{{ $currencyIndex }}][percent_charge]" value="{{ getAmount($gatewayCurrency->percent_charge, 8) }}" required>
