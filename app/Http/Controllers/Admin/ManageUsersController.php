...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $totalOrders = Sell::where('user_id',$user->id)->groupBy('code')->get()->count();
        $countries = json_decode(file_get_contents(resource_path('views/partials/country.json')));
        return view('admin.users.detail', compact('pageTitle', 'user','totalDeposit','totalTransaction','supportTickets','totalOrders','countries'));
    }
