        ...
        <div class="col-12">
            <div class="row gy-4">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                              type="2" value="{{ $totalOrders }}" title="Orders" style="7" link="{{ route('admin.order.all',$user->id) }}" icon="las la-cart-arrow-down" bg="6" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                              type="2" value="{{ showAmount($totalDeposit) }}" title="Payments" style="7" link="{{ route('admin.order.all',$user->id) }}" icon="las la-wallet" bg="8" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                              type="2" value="{{ $supportTickets }}" title="Tickets" style="7" link="{{ route('admin.ticket.index',$user->id) }}" icon="la la-ticket" bg="2" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                              type="2" value="{{ $totalTransaction }}" title="Transactions" style="7" link="{{ route('admin.report.transaction', $user->id) }}" icon="las la-exchange-alt" bg="17" />
                </div>
